...
$product = [
    ...
    'price_from'  => '45.00',
    'sizes'       => [
        ['label' => '3 Pieces',  'price' => '45.00'],
        ['label' => '6 Pieces',  'price' => '85.00'],
        ['label' => '12 Pieces', 'price' => '160.00'],
    ],
];
    ...
    if ($name === '' || $contactInfo === '' || $size === '') {
        ...
        if ($pdo === null) {
            ...
            try {
                ...
                $stmt = $pdo->prepare(
                    'INSERT INTO orders (customer_name, contact_info, size, quantity, message, amount)
                     VALUES (:name, :contact, :size, :qty, :message, :amount)'
                );
                $stmt->execute([
                    ':name'    => $name,
                    ':contact' => $contactInfo,
...
<head>
    ...
    <meta property="og:image" content="images/graham-bars.svg">
    ...
    <link rel="icon" href="images/graham-bars.svg" type="image/svg+xml">
</head>
<body>
        ...
        <div class="container hero-inner">
            ...
            <div class="hero-visual">
                <div class="hero-visual-frame">
                    ...
                    <img src="images/graham-bars.svg" alt="Layered Graham Bars with creamy filling, ready to be sliced and served" class="hero-product-img">
    ...
    <section class="showcase section-pad" id="product">
        <div class="container showcase-inner">
            <div class="showcase-visual reveal">
                <img src="images/graham-bars.svg" alt="Close-up of stacked <?php echo htmlspecialchars($product['name']); ?> showing layers of graham crust and cream">
                <div class="price-tag">
            ...
            <div class="contact-visual reveal reveal-delay-1">
                ...
                <form class="order-form" method="POST" action="#contact">
                    <div class="form-group">
                        ...
                        <input type="text" id="customer_name" name="customer_name" placeholder="Juan Dela Cruz"
